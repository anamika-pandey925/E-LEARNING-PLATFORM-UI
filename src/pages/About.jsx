    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16 text-left">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        >
          ...
          <p className="text-slate-355 text-base sm:text-lg leading-relaxed">
        ...
        <motion.div 
          className="lg:col-span-5 aspect-video w-full overflow-hidden rounded-3xl border border-white/10 shadow-2xl"
      ...
      {/* Stats Board */}
      <section className="grid grid-cols-2 lg:grid-cols-4 gap-6 py-12 border-y border-slate-800/80">
        {stats.map((st, idx) => (
          <div key={idx} className="flex items-center space-x-4 p-5 rounded-2xl glass border border-slate-850">
            ...
            <div>
              <div className="text-2xl font-bold font-poppins text-slate-100">{st.value}</div>
      ...
      {/* Meet Instructors - replaced with neutral Coming Soon per rule 11 */}
      <section className="space-y-12">
        ...
        <div className="max-w-md mx-auto p-8 rounded-2xl border border-slate-800 bg-slate-950/40 text-center space-y-4 glass">
          <div className="w-16 h-16 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 mx-auto border border-slate-700/50">
            <FiUser size={32} />
          </div>
          <div className="space-y-1">
            <h3 className="font-poppins font-bold text-xl text-slate-100">Coming Soon</h3>
            <p className="text-sm text-slate-405 font-medium">Instructor information will be available soon.</p>
          </div>
        </div>
      </section>
