  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-4 py-16 relative">
      ...
      <motion.div
        ...
        className="glass w-full max-w-md p-8 rounded-3xl border border-slate-800 text-center space-y-6 relative"
      >
        <h1 className="font-poppins font-extrabold text-7xl text-emerald-400">404</h1>
        <div className="space-y-2">
          <h2 className="font-poppins font-bold text-xl text-slate-100">Page Not Found</h2>
